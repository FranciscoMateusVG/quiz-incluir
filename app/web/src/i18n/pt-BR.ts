...
export const t = {
  ...
  chooseUnit: "Escolha uma unidade",
  chooseUnitHint: "Veja os quizzes agrupados pela unidade do material.",
  quizzesCount: (n: number) => `${n} ${n === 1 ? "quiz" : "quizzes"}`,
  noUnits: "Nenhuma unidade disponível",
  noUnitsHint: "Nenhum quiz foi marcado com uma unidade ainda.",
  backToUnits: "Todas as unidades",
  chooseLevel: "Escolha um nível",
  chooseLevelHint: "Veja os quizzes agrupados pelo nível da turma.",
  levelLabel: (level: string) => `Nível ${level}`,
  noLevels: "Nenhum nível disponível",
  noLevelsHint: "Nenhum quiz foi associado a um nível de turma ainda.",
  backToLevels: "Todos os níveis",
